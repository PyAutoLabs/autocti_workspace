...
in the `plot/ccd/dataset_1d/fit.py` script and uses this database to create figures of the fit.
...
The fits performed in the `plot/ccd/dataset_1d/fit.py` script output results to hard-disk, in the `output` folder.
...
"""
output_path = path.join("scripts", "plot", "images", "ccd", "dataset_1d")
output_format = "png"
...
figure of all 32 datasets via the `aplt.subplot_dataset_1d_list` function.
"""
